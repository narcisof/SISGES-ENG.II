...
$sql = "select * from funcao where id = $id_edit";
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="edit_bdf.php" method="post">
                                    <input type="hidden" name="id_to_edit" value= <?php echo '"'.$row['id'].'"'; ?> >
                                    <label for="text">Nome</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="email_address" name="nomef" class="form-control" placeholder="Nome da função" value= <?php echo '"'.$row['nomef'].'"'; ?> >
                                        </div>
                                    </div>
