                        ...
                        <div class="body">
                            <form action="cadastro_cliente.php" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="email_address" name="nome" class="form-control" placeholder="Nome do Bibliotecário" required>
                                        </div>
                                    </div>
                                ...
                                <div class="header">
                                    ...
                                    <button type="submit" class="btn btn-primary m-t-15 waves-effect">GERAR</button>
                            </form>
                        </div>
                    </div>
                </div>
