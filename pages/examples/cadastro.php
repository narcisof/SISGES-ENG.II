                        ...
                        <div class="body">
                            <form action="cadastro_cliente.php" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="email_address" name="nome" class="form-control" placeholder="Nome Completo" required>
                                        </div>
                                    </div>
                                    <label for="text">Email</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="email" id="password" name="email" class="form-control" placeholder="example@example.com">
                                        </div>
                                    </div>
